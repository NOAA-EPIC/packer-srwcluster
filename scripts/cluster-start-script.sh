...
find /opt/spack-stack/spack/share/spack/lmod/openmpi/4.1.6-*/intel/2021.10.0/ufs-srw-app-env -iname "*.lua" | xargs grep -l 2023.04 | xargs sed -i 's/2023.04-.*/2023.01")/g' 
module load ufs-srw-app-env
cd /opt
